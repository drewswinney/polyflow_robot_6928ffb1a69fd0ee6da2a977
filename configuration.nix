...
let
  user      = "admin";
  password  = "password";
  hostname  = "6928ffb1a69fd0ee6da2a977";
  homeDir   = "/home/${user}";
...
in
{
  ...
  hardware.deviceTree = {
    ...
    overlays = [
      {
        name = "waveshare-canfd-can0-only";
        dtsText = ''
          /dts-v1/;
          /plugin/;
          ...
          / {
            ...
            /* Enable spi0 and attach CAN0 (MCP2518FD) on CS0, INT on can0InterruptGpio */
            fragment@0 {
              target = <&spi0>;
              __overlay__ {
                status = "okay";
                ...
                can0: mcp251xfd@0 {
                  ...
                  reg = <0>;
                  spi-max-frequency = <${toString canSpiMaxFrequency}>;
                  interrupt-parent = <&gpio>;
                  interrupts = <${toString can0InterruptGpio} IRQ_TYPE_LEVEL_LOW>;
                  clocks = <&can0_osc>;
                  clock-names = "osc";
                  status = "okay";
                };
            ...
            fragment@1 {
              ...
              __overlay__ {
                can0_osc: can0_osc {
                  ...
                  #clock-cells = <0>;
                  clock-frequency = <${toString canOscillatorHz}>;
                };
              };
            };
          };
  ...
  systemd.network = {
    ...
    networks."40-can0" = {
      ...
      networkConfig.ConfigureWithoutCarrier = true;
      canConfig = {
        BitRate = canBaseBitRate;
        DataBitRate = canFdDataBitRate;
        FDMode = true;
        RestartSec = "100ms";
      };
    };
  ...
  environment.systemPackages =
    (with pkgs; [ git python3 can-utils ]) ++
